...
### 1. [IP Address Management (IPAM)](adr/ADR-IPAM.md)
...
### 2. [Authentication Strategy](adr/ADR-AUTHENTICATION.md)
...
### 3. [Control Plane Protocol](adr/ADR-Control-Plane.md)
...
### 4. [MTU and Fragmentation](adr/ADR-MTU-Fragmentation.md)
...
### 5. [Routing Mode](adr/ADR-Routing.md)
