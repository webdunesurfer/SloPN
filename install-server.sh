...
# License: GNU GPLv3
# Version: 0.9.5-diag-v25
# Updated: 2026-02-16 02:30:00
...
echo -e "${BLUE}                Version: 0.9.5-diag-v25             ${NC}"
echo -e "${BLUE}====================================================${NC}"
...
VERSION=$(grep "const ServerVersion =" cmd/server/main.go | cut -d'"' -f2 || echo "0.9.5-diag-v25")
# Force IPv4
