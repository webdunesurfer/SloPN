...
# License: GNU GPLv3
# Version: 0.9.5-diag-v21
# Updated: 2026-02-16 00:45:00
...
echo -e "${BLUE}                Version: 0.9.5-diag-v21             ${NC}"
echo -e "${BLUE}====================================================${NC}"
...
VERSION=$(grep "const ServerVersion =" cmd/server/main.go | cut -d'"' -f2 || echo "0.9.5-diag-v21")
# Force IPv4
