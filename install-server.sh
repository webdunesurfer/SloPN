...
# License: GNU GPLv3
# Version: 0.9.5-diag-v23
# Updated: 2026-02-16 02:00:00
...
echo -e "${BLUE}                Version: 0.9.5-diag-v23             ${NC}"
echo -e "${BLUE}====================================================${NC}"
...
VERSION=$(grep "const ServerVersion =" cmd/server/main.go | cut -d'"' -f2 || echo "0.9.5-diag-v23")
# Force IPv4
